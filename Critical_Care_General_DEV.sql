...
--TOP 1000 
	...
	, sp.Der_Age_at_CDS_Activity_Date
	, cc.CC_Type
	, cc.CC_Patient_Type
	--, cc.CC_Admission_Type
	, am.Admission_Method_Desc_Short
	, dm.Discharge_Method_Desc_Short
	--, cc.Unbundled_HRG
	...
	--, icb.ICB22CD as 'Population_ICB22CD'
	--, icb.ICB22CDH as 'Population_ICB22CDH'
	--, icb.ICB22NM as 'Population_ICB22NM'
	--, icb3.NHSER22CD as 'Population_R22CD'
	--, icb3.NHSER22CDH as 'Population_R22CDH'
	--, icb3.NHSER22NM as 'Population_R22NM'
	...
	--, icb2.ICB22CD as 'Provider_ICB22CD' 
	--, icb2.ICB22CDH as 'Provider_ICB22CDH'
	--, icb2.ICB22NM as 'Provider_ICB22NM'
	--, icb2.NHSER22CD as 'Provider_R22CD'
	--, icb2.NHSER22CDH as 'Provider_R22CDH'
	--, icb2.NHSER22NM as 'Provider_R22NM'

	--, case when icb.ICB22CDH = icb2.ICB22CDH then 'In_area' else 'Out_of_area' end as 'ICB_Match'
	--, case when icb3.NHSER22CDH = icb2.NHSER22CDH then 'In_area' else 'Out_of_area' end as 'R22_Match'
...
from NHSE_SUSPlus_Live.dbo.tbl_Data_PbR_CC cc
	...
	left outer join NHSE_SUSPlus_Live.dbo.tbl_Data_SEM_APCS_1920_Der der
		on sp.APCS_Ident = der.APCS_Ident
	left outer join NHSE_SUSPlus_Live.dbo.tbl_Data_SEM_APCS_1920_Cost co
